...
def age_detect():
    ...
    faceProto = "IRS2021/opencv_face_detector.pbtxt"
    faceModel = "IRS2021/opencv_face_detector_uint8.pb"
    ageProto = "IRS2021/age_deploy.prototxt"
    ageModel = "IRS2021/age_net.caffemodel"
    genderProto = "IRS2021/gender_deploy.prototxt"
    genderModel = "IRS2021/gender_net.caffemodel"

    MODEL_MEAN_VALUES = (78.4263377603, 87.7689143744, 114.895847746)
    ageList = ['(0-2)', '(4-6)', '(8-12)', '(15-20)', '(25-32)', '(38-43)', '(48-53)', '(60-100)']
    mapping = {'(0-2)': 0, '(4-6)': 1, '(8-12)': 2, '(15-20)': 3, '(25-32)': 4, '(38-43)': 5, '(48-53)': 6,
               '(60-100)': 7}
